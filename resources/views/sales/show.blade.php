        ...
        <div class="flex items-center justify-between">
            <div>
                <div class="flex items-center gap-3">
                    <a href="{{ route('sales.index') }}" class="text-text-muted hover:text-white">
                        <span class="material-symbols-outlined">arrow_back</span>
                    </a>
                    <div>
                        <h2 class="text-2xl font-bold text-white font-display">Detail Penjualan</h2>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="grid md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="text-text-muted text-xs uppercase tracking-wider">Pelanggan</label>

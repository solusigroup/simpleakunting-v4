<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-white font-display">Import Contacts</h2>
                <p class="text-text-muted text-sm mt-1">Upload file Excel untuk import Pelanggan/Pemasok secara massal</p>
            </div>
        ...
        <div class="flex items-start gap-4">
            ...
            <div class="flex-1">
                ...
                <ol class="list-decimal list-inside space-y-2 text-text-muted text-sm">
                    ...
                    <li>Isi data kontak sesuai format (lihat sheet Instructions)</li>
    ...
    <div class="bg-surface-dark/30 border border-border-dark rounded-2xl p-6 mb-6">
        <div class="flex items-center justify-between">
            ...
            <x-btn type="primary" onclick="window.location.href='/contacts/import/template'">

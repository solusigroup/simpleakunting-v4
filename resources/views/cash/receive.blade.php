<x-app-layout>
    ...
    <script>
        ...
        function addItem() {
            ...
            const fromAccountSelect = tr.querySelector('[name^="from_account_"]');
            if (typeof makeSearchable === 'function' && fromAccountSelect) {
                makeSearchable(fromAccountSelect);
            }
        }

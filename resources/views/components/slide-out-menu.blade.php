...
<div x-data="{ open: false }" 
    ...
    <!-- Slide-Out Panel (Teleported to Body) -->
    <template x-teleport="body">
        <div x-show="open"
             ...
             class="fixed top-0 right-0 h-full w-full sm:w-96 bg-background-dark border-l border-border-dark shadow-2xl z-[100] flex flex-col overflow-hidden"
             x-cloak>
